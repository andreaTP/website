...
-   sbt-swagger-codegen (Models, Client and Server code generation integrated as an SBT plugin.
    Generate code from your Swagger files): <https://github.com/unicredit/sbt-swagger-codegen>
